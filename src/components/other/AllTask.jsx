...
const AllTask = ({ tasks }) => {
  ...
  <div className='mt-6'>
    ...
    <div className='bg-[#1c1c1c] rounded-xl border border-[#2a2a2a] overflow-hidden overflow-x-auto'>
      <div className='min-w-[500px]'>
        ...
        {employees.map((emp, idx) => (
          <div key={idx} className='flex items-center px-5 py-3.5 border-b border-[#222] last:border-0 hover:bg-[#222] transition-colors'>
            ...
            <div className='flex-1 flex justify-center'>
              <span className='text-xs font-medium px-3 py-1 rounded-full bg-blue-950 text-blue-300 min-w-[36px] text-center'>{emp.new}</span>
            </div>
            <div className='flex-1 flex justify-center'>
              <span className='text-xs font-medium px-3 py-1 rounded-full bg-amber-950 text-amber-300 min-w-[36px] text-center'>{emp.active}</span>
            </div>
            <div className='flex-1 flex justify-center'>
              <span className='text-xs font-medium px-3 py-1 rounded-full bg-emerald-950 text-emerald-300 min-w-[36px] text-center'>{emp.completed}</span>
            </div>
            <div className='flex-1 flex justify-center'>
              <span className='text-xs font-medium px-3 py-1 rounded-full bg-red-950 text-red-400 min-w-[36px] text-center'>{emp.failed}</span>
            </div>
          </div>
        ))}
      </div>
