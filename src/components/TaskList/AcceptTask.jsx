  ...
  return (
    <div className='flex-shrink-0 h-full w-[300px] p-5 bg-red-400 rounded-xl'>
      <div className='flex justify-between items-center'>
        <h3 className='bg-red-600 text-sm px-3 py-1 rounded'>{data.priority}</h3>
        <h4 className='text-sm'>{data.deadline ? new Date(data.deadline).toLocaleDateString() : 'No deadline'}</h4>
      </div>
